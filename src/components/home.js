...
for(let i=0;i<json.length;i++){
  ...
  const response = await fetch(`https://${state.backend}/api/b/bookroom`, {
    ...
    body: JSON.stringify({ room: roomno })  // sending { room: "10" }
  });
...
<h5 className="font-bold"> Boys Hostels</h5>
...
<h5 className="pt-2 mb-6 font-bold text-white"> Boys Hostels</h5>
...
<p className="ml-2 leading-normal text-sm"><span className="font-bold">Active</span> from your day of joining</p>
...
<ul className='thisisul' id='ulof'>
  <li className='text-whit twl'>Mess Time Table Has been Updated on Notice Board</li>
  ...
  <li className='text-whit twl'>
  Attention all students! We're excited to announce the upcoming Navratri meet that will be held on the  ground Floor. More details will provided soon, Let's gear up and make this event a success!
  </li>
</ul>
