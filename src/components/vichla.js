...
<ul className="mb-2 grules">
 <li className='m-2 daj'><ArrowRightRoundedIcon className='mbb5'/>A gate pass Will be only Acepted if Permission is given by parents.</li>
 <li className='m-2 daj'> <ArrowRightRoundedIcon className='mbb5'/>Gate will be not opened after 10:30 if there is no Gate Pass</li>
 
 <li className='m-2 daj'><ArrowRightRoundedIcon className='mbb5'/>Students on leave will not have to put there attendance</li>
 <li className='m-2 daj'><ArrowRightRoundedIcon className='mbb5'/>You have return to hostel before 10:30PM otherwise fill leave form</li>
